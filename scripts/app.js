riot.tag2('carousel', '<div class="carousel"> <leftarrow></leftarrow> <div style="margin-top: -7px; padding-left: 12px; padding-right: 12px;"><span class="fonts utility">{current} / {opts.total}</span></div> <rightarrow></rightarrow> </div>', '', '', function(opts) {
