...
riot.tag2('dropdown', '<div class="dropdown-wrapper"> <div class="dropdown"> <p class="fonts utility">{opts.category}</p> <div class="dropdown-header"> <div class="fonts header-1 dropdown-title">{opts.subcategory}</div> <div class="chevron-container"> <chevron></chevron> </div> </div> </div> <div class="options-container"> <div class="options"> <a class="fonts utility" href="#"><p>Bathrooms</p></a> <a class="fonts utility" href="#"><p>Entries</p></a> <a class="fonts utility" href="#"><p>Libraries</p></a> <a class="fonts utility" href="#"><p>Bars & Wine Cellars</p></a> <a class="fonts utility" href="#"><p>Fireplaces</p></a> <a class="fonts utility" href="#"><p>Details</p></a> </div> </div> </div>', '', '', function(opts) {
});
...
riot.tag2('mainmenu', '<div style="height: 672px; width: 1151px; display: flex; background: white; box-shadow: 0 2px 10px 0 rgba(0,0,0,0.10); position: absolute; z-index: 2; margin-top: 24px;"> <div style="width: 50%"> <div style="margin-left: 128px; margin-top: 120px;"> <mainlink text="Portfolio" href="#"></mainlink> <mainlink text="A Closer Look"></mainlink> <mainlink text="About"></mainlink> <mainlink text="News"></mainlink> <a href="#"><p class="fonts utility">Contact Us</p></a> <a href="#"><p class="fonts utility">Newsletter</p></a> </div> </div> <div style="width: 50%; background: white"> <div style="height: 324px; width: 100%; background: url(\'./assets/images/sub_image.png\'); background-position: center center; background-repeat: no-repeat; background-size: cover; margin-bottom: 36px;"></div> <p class="fonts utility">Newsletter</p> <div class="subscribe-form"> <input type="text" placeholder="Email address..."></input> <div class="subscribe-button"><div>Subscribe</div></div> </div> <div class="social-icons"> <facebookicon></facebookicon> <instagramicon></instagramicon> <twittericon></twittericon> <pinteresticon></pinteresticon> <houzzicon></houzzicon> <dicon></dicon> </div> </div> </div>', '', '', function(opts) {
});
